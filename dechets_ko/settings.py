"""
Django settings for dechets_ko project.
"""
...
SECRET_KEY = os.environ.setdefault('SECRET_KEY','django-insecure-your-secret-key-here')
...
WSGI_APPLICATION = 'dechets_ko.wsgi.application'
